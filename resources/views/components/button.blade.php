@props([
	...
	'rose' => ' bg-rose-800 hover:bg-rose-700 active:bg-rose-900 focus:outline-none focus:border-rose-900 focus:ring ring-rose-300 ',
],
'color' => 'black'
])
...
<button {{ $attributes->merge([
	'type' => 'submit', 
	'class' => 'inline-flex ' . $colors[$color] . ' items-center px-4 py-2 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest focus:outline-none disabled:opacity-25 transition ease-in-out duration-150'
	]) }}>
    {{ $slot }}
</button>
