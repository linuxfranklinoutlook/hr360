                ...
                <div class="overflow-hidden shadow-xs sm:rounded-lg">
                    ...
                    <div class="my-4">
                        <x-link-button color="blue"
                            onClick="Livewire.emit('openModal', 'reset-password', {{ json_encode(['id' => $user->id]) }})">
                            Password reset
                        </x-link-button>
                        ...
                        <form method="get" action="">
                            ...
                            <div class="flex flex-col my-6">
                                <div
                                    class="flex flex-col my-6 align-middle inline-block min-w-full	bg-white shadow-md px-4 sm:px-6 md:px-8 lg:px-10 py-8 rounded-3xl w-80
				max-w-md
			  ">
				...
				Blue Hex Software
                                    ...
                                    <div class="mt-5">
                                        <div class="flex flex-col mb-5">
                                            <label for="name"
                                                class="mb-1 text-xs tracking-wide text-gray-900">Name:</label>
						...
						"
                                        ...
                                        <div class="mt-5">
                                            <div class="flex flex-col mb-5">
                                                ...
                                                <label for="email"
                                                    class="mb-1 text-xs tracking-wide text-gray-900">E-Mail
                                                    Address:</label>
                                                <div class="relative">
                                                    <div
                                                        class="
						...
						">
						  ...
						  @error('email') is not valid @enderror('email') "
                                            ...
                                            <div class="mt-5">
                                                <div class="flex flex-col mb-5">
                                                    <label for="role"
                                                        class="mb-1 text-xs tracking-wide text-gray-900">Role:</label>
                                                    <div class="relative">
                                                        <div
                                                        ...
                                                        <input disabled id="role" type="text"
                                                            value="{{ $user->role->name }} (Guard: {{ $user->role->guard_name }})"
                                                            name="role"
                                                ...
                                                <div class="mt-5">
                                                    <div class="flex flex-col mb-5">
                                                        <label for="role"
                                                            class="mb-1 text-xs tracking-wide text-gray-900">{{ $user->role->name }}
                                                            Permissions:</label>
                                                        <div class="relative">
                                                            <div
                                                                class="inline-flex items-center justify-center absolute left-0 top-0 h-full w-10 text-gray-400">
