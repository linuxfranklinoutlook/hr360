    ...
    <div class="flex flex-col w-65">
        ...
        <div class="flex flex-col flex-grow pt-6 pb-4 overflow-y-auto">
            ...
            <div class="flex items-center justify-center mt-6">
                <div class="flex items-center">
                    <span class="text-gray-50 text-1xl mx-2 "><a href="{{route('dashboardController')}}" class="hover:text-blue-500">Blue Hex Software Pvt Limited
                        </a></span>
                </div>
            </div>
            ...
            <div class="mt-5 flex-1 flex flex-col">
                <nav class="flex-1 px-2 space-y-1">
                    ...
                    <a href="{{ route('dashboardController') }}"
