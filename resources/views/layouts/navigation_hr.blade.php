<div x-data="{ sidebarOpen: false }" class="flex h-screen bg-gray-200">
	<div :class="sidebarOpen ? 'block' : 'hidden'" @click="sidebarOpen = false"
		class="fixed z-15 inset-0 bg-black opacity-50 transition-opacity lg:hidden"></div>

	<div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
		class="fixed z-15 inset-y-0 left-0 w-90 transition duration-300 transform bg-gray-800 overflow-y-auto lg:translate-x-0 lg:static lg:inset-1">
		...
		<div class="flex items-center justify-center mt-6">
			<div class="flex items-center">
				<span class="text-gray-50 text-1xl mx-2 "><a href="/dashboard_test">Blue Hex Software Pvt Limited </a></span>
			</div>
		</div>
		<div class="group inline-block p-2 flex items-center justify-center mt-2 text-white ">
			<div class="hidden sm:flex sm:items-center sm:ml-6">
			   <x-dropdown align="center" width="52">
				  <x-slot name="trigger">
					 <button
						class="flex items-center text-l font-medium bg-gray-800 text-gray-50 hover:text-white hover:border-gray-900 focus:outline-none focus:text-red-500 focus:border-gray-900 transition duration-150 ease-in-out">
